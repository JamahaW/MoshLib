 ...
 */
void goTime(uint32_t runtime, int8_t speed = conf.default_speed_tick);
 ...
 */
void goTick(int32_t ticks, uint8_t speed = conf.default_speed_pwm);
 ...
 */
void turnAngle(int16_t a, int16_t speed = conf.default_speed_pwm);
 ...
 */
void alignLine(uint32_t duration = conf.align_duration);
 ...
 */
void turnLineL(int8_t crosses = 1, int16_t speed = conf.default_speed_pwm);
 ...
 * @param speed ШИМ скорость
 */
void turnLineR(int8_t crosses = 1, int16_t speed = conf.default_speed_pwm);
 ...
 * @param speed ШИМ скорость движения
 */
void wallFront(mosh::hardware::DistanceSensor& sensor, uint8_t distance, uint8_t speed = conf.default_speed_pwm);
 ...
 * @param speed ШИМ скорость движения
 */
void wallFront(uint8_t distance, uint8_t speed = conf.default_speed_pwm);
 ...
 * @param speed ШИМ скорость движения
 */
void wallBack(mosh::hardware::DistanceSensor& sensor, uint8_t distance, int16_t speed = conf.default_speed_pwm);
 ...
 * @param speed ШИМ скорость движения
 */
void wallBack(uint8_t distance, uint8_t speed = conf.default_speed_pwm);
 ...
 * @param speed скорость
 */
void wallTimeL(uint8_t distance, uint32_t runtime, uint8_t speed = conf.default_speed_tick);
 ...
 * @param speed скорость
 */
void wallTimeR(uint8_t distance, uint32_t runtime, uint8_t speed = conf.default_speed_tick);
...
/// @param speed скорость
void lineTimeL(uint32_t runtime, uint8_t speed = conf.default_speed_tick);

/// @brief движение по линии по правому датчику
/// @param speed скорость
void lineTimeR(uint32_t runtime, uint8_t speed = conf.default_speed_tick);

/// @brief движение по линии по двум датчикам
/// @param speed скорость
void lineTimeLR(uint32_t runtime, uint8_t speed = conf.default_speed_tick);

/// @brief движение по линии по P-регулятору
/// @param speed скорость
void lineTimeP(uint32_t runtime, uint8_t speed = conf.default_speed_tick);
 ...
 */
void lineCrossP(uint8_t crosses = 1, uint8_t speed = conf.default_speed_tick);

/// @brief Движение по линии на расстояние P-регулятор
/// @param distance Расстояние движения
/// @param speed скорость ТИК
void lineDistP(int32_t distance, uint8_t speed = conf.default_speed_tick);
